...
class CustomUserAdmin(BaseUserAdmin):
    ...
    search_fields = ('email', 'name', 'nome_colaborador')
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'name', 'password1', 'password2', 'is_staff', 'is_superuser', 'sexo', 'raca', 'estado_civil', 'necessidade_especial', 'numero_tel', 'nacionalidade', 'nome_colaborador')
        }),
    )
